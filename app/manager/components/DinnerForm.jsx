...
`)
    ...
    async function handleSubmit(formData){
      if (!formData.get('name1').trim() || !formData.get('price').trim()) {
        ...
        resetForm(formData.get('section'))
    }
    ...
    function resetForm(props){
        ...
        document.querySelector('#upgrade1').value = ''
        document.querySelector('#upgrade2').value = ''
        document.querySelector('#upgrade3').value = ''
