          ...
          <div className='modal-text'>
              ...
              <div className="right-column">
                          <div className="name-price">
                            <span>
                              <span className="name" id='cocktail-modal-name1'></span>
                            </span>
                            <span className="price" id='cocktail-modal-price'></span>
                          </div>
                          <div className="description1" id='cocktail-modal-description1'></div>
                          <div className="description2" id='cocktail-modal-description2'></div>
                          <div id='cocktail-modal-typos' className='typo'></div>
                          <br/>
                          <hr/>
                          <br/>
                            <div id='cocktail-modal-staff-info' style={{whiteSpace:'pre-line'}}></div>
                          <br/><br/>
              </div>
            </div>{/* .modal-text */}
          </div>{/* .modal-content */}      
