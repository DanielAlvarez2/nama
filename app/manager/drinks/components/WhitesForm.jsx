...
export default function WhitesForm(){
    ...
    function resetForm(){
        ...
        document.querySelector('#form h1').textContent = 'ADD NEW WHITE WINE'
        ...
        <>
            ...
            >
                ...
                <div style={{display:'flex'}}>
                    <button id='submit-button-form' type='submit'>+ White Wine</button>
                    <button type='button'
                            onClick={resetForm} 
