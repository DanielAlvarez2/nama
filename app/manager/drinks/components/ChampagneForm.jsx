...
export default function ChampagneForm(){
    ...
    async function handleSubmit(formData){
        if (!formData.get('name1').trim() || !formData.get('price').trim() || !formData.get('vintage').trim()) {
            alert('Name and Price are required')
            setTimeout(()=>{
                document.querySelector('#vintage').value = formData.get('vintage')
                document.querySelector('#name1').value = formData.get('name1')
                document.querySelector('#name2').value = formData.get('name2')
    ...
    function resetForm(){
        ...
        document.querySelector('#typos').value = ''
        ...
        document.querySelector('#form h1').textContent = 'ADD NEW CHAMPAGNE'
        ...
        <>
            ...
            >
                ...
                <div style={{display:'flex'}}>
                    <button id='submit-button-form' type='submit'>+ Champagne</button>
                    <button type='button'
                            onClick={resetForm} 
