...
export default function RoseForm(){
    ...
    function resetForm(){
        ...
        document.querySelector('#form h1').textContent = 'ADD NEW ROSÉ WINE'
        ...
        <>
            ...
            >
                ...
                <div style={{display:'flex'}}>
                    <button id='submit-button-form' type='submit'>+ Rosé Wine</button>
                    <button type='button'
                            onClick={resetForm} 
